...
//        System.out.println("Setup Done!");
        map = new Map();
        map.addPoint(root);
        map.addPoint(almost_there);
        map.addPoint(not_quite);
        map.addPoint(midpoint);
        map.addPoint(little_further);
        map.addPoint(end);
        map.addPoint(another_point);
        map.addPoint(point_a);
        map.addPoint(point_b);
        map.addPoint(point_c);
        map.addPoint(point_d);
        root = map.inflateMap().get(0);
